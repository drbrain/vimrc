...
aucmd("FileType", "html", "setlocal tw=78 ts=2 sts=2 sw=2 et")
aucmd("FileType", "htmldjango", "setlocal tw=78 ts=2 sts=2 sw=2 et")
...
aucmd("FileType", "toml", "setlocal tw=78 ts=4 sts=4 sw=4 et nospell")
